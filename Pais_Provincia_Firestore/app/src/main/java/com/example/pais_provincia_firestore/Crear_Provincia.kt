...
class Crear_Provincia : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cantidad_habitantes_provincia =
            findViewById<EditText>(R.id.input_cantidad_hab_provincia)
        ...
        crearProvincia.setOnClickListener {
            FirestoreData.crearProvincia(
                nombre_provincia.text.toString(), capital_provincia.text.toString(),
